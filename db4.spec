...
Patch21: db-4.3.29-sparc64.patch
Patch22: db-4.6.21-1.85-compat.patch
Patch23: db-4.7.25-acmacro.patch
...
%patch21 -p1 -b .sparc64
%patch22 -p1 -b .185compat
%patch23 -p1 -b .acmacro
...
* Sun Feb 12 2011 Jindrich Novy <jnovy@redhat.com> 4.7.25-17
- fix license tag (#784662)

* Fri Jun  4 2010 Jindrich Novy <jnovy@redhat.com> 4.7.25-16
- add Requires: db4-cxx to db4-devel (#596157)

* Mon Mar 15 2010 Jindrich Novy <jnovy@redhat.com> 4.7.25-15
- apply backported patch from 4.8.26 to fix dbverify (#563610, #472131)
  (patch backported by Noriko Hosoi)

* Mon Mar 15 2010 Jindrich Novy <jnovy@redhat.com> 4.7.25-14
- enable SHA-256 signatures for BDB packages (#565655)

* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 4.7.25-13.1
- Rebuilt for RHEL 6
